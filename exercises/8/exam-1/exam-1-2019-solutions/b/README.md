Задача 1. а) (3 т.) Да се реализира функция sum-digit-divisors, която намира сумата на тези от положителните цифри на дадено естествено число, които са му делители.
